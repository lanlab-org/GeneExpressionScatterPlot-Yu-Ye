(function(g) {
	...
	function w(a) {
		...
		g.each(a, function(b, d) {
			if (g.isPlainObject(d)) w(d);
				...
				o && (-1 === c.indexOf("<?xml") && (c = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + c), c = c.replace(
	...
	i.Client.prototype = {
		...
		glue: function(a, b) {
			...
			this.domElement && (this.domElement.appendChild(this.div), this.div.innerHTML = this.getHTML(c.width, c.height).replace(
				/&/g, "&amp;"))
		},
		...
		getHTML: function(a, b) {
			...
			if (navigator.userAgent.match(/MSIE/)) var e =
				...
				d = d + ('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + e +
					'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="' + a + '" height="' +
					b + '" id="' + this.movieId +
			...
			else d += '<embed id="' + this.movieId + '" src="' + i.moviePath +
				'" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="' + a + '" height="' + b + '" name="' +
				this.movieId +
		...
		destroy: function() {
			var a = this;
			this.domElement && this.div && (g(this.div).remove(), this.div = this.domElement = null, g.each(i.clients,
				function(b, d) {
		...
		receiveEvent: function(a, b) {
			...
			switch (a) {
				...
				case "mouseover":
					...
					break;
				case "mouseout":
					this.domElement && this.cssEffects && (this.recoverActive = !1, this.domElement.hasClass("active") && (this.domElement
						.removeClass("active"), this.recoverActive = !0));
					break;
				case "mousedown":
					this.domElement &&
	...
	i.hasFlash = function() {
		try {
			...
			if (navigator.mimeTypes &&
				navigator.mimeTypes["application/x-shockwave-flash"] !== q && navigator.mimeTypes["application/x-shockwave-flash"]
	...
	var x = function(a, b) {
		...
		z = function(a, b) {
			for (var d = y(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(
						e, "g"), i = b.escapeChar !== q ? b.escapeChar : "\\", k = function(a) {
						for (var b = "", c = 0, d = a.length; c < d; c++) 0 < c && (b += f), b += e ? e + ("" + a[c]).replace(g, i + e) +
							e : a[c];
						return b
					}, l = b.header ? k(c.header) + d : "", n = b.footer && c.footer ? d + k(c.footer) : "", m = [], h = 0, p = c.body
					.length; h < p; h++) m.push(k(c.body[h]));
			return {
				str: l + m.join(d) +
					n,
				rows: m.length
			...
			var a = c._flash,
				...
				k, l, h = function(a) {
					...
					for (var b = 0, d = a.length; b < d; b++) {
						...
						j || ("number" === typeof a[b] || a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/) ? j = n(
							f, "c", {
								attr: {
									t: "n",
									r: h
